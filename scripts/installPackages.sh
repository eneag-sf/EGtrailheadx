...
sfdx force:package:install --package 04t4S000000HweFQAS -w 10 


#install Launch Flow Modal package
#https://appexchange.salesforce.com/appxListingDetail?listingId=a0N3A00000FZRGPUA5
sfdx force:package:install --package 04t2E000003VsuMQAS -w 10